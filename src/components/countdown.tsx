...
interface CountdownProps {
  ...
  className?: string;
  label?: string; // Optional label text, defaults to "FALTAM PARA O LANÇAMENTO"
}
...
export default function Countdown({
  ...
  const ariaLabel = useMemo(
    () =>
      `Contagem regressiva: ${timeLeft.days} dias, ${timeLeft.hours} horas, ${timeLeft.minutes} minutos e ${timeLeft.seconds} segundos restantes`,
    [timeLeft]
  );
